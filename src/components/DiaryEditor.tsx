  ...
  return (
    <div className="space-y-2">
      <textarea
        ...
        className="w-full min-h-56 resize-none bg-zinc-50 border border-zinc-200 rounded-2xl px-4 py-3 text-sm text-zinc-800 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-zinc-900 transition-all leading-relaxed"
        rows={8}
      />
